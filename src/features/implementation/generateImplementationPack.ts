...
export function isImplementationPackReady(
  capabilities: ProposedCapability[],
): boolean {
...
export function generateImplementationPack({
  ...
  if (!isImplementationPackReady(capabilities)) {
    return `# WebMCP Implementation Pack

Status: Incomplete

Select at least one proposed WebMCP capability before copying or downloading this implementation brief.

Generated by WebMCP Simulator. No implementation action has been specified.`
  }
